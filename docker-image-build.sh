...
docker image build -f ${FirstServiceDir}/Dockerfile -t ${FirstServiceName}:${AppVersion} .
...
docker image build -f ${UserProfileName}/Dockerfile -t ${UserProfileName}:${AppVersion} .
...
docker image build -f ${TrainingManagementName}/Dockerfile -t ${TrainingManagementName}:${AppVersion} .
...
docker image build -f ${EnrolmentDefermentExemptionName}/Dockerfile -t ${EnrolmentDefermentExemptionName}:${AppVersion} .
...
docker image build -f ${MedicalScreeningName}/Dockerfile -t ${MedicalScreeningName}:${AppVersion} .
...
docker image build -f ${NotificationName}/Dockerfile -t ${NotificationName}:${AppVersion} .
