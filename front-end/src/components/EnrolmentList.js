    ...
    return (<div>
        <div className='col-md-12 row'>
            <div className='col-md-12 row'>
                ...
                <div className='col-md-4'>
                    <FormControl className={classes.formControl}>
                        <InputLabel id="demo-simple-select-helper-label">Field Specialization</InputLabel>
                        <Select
                            labelId="demo-simple-select-helper-label"
                            id="demo-simple-select-helper"
                        >
                            <MenuItem value={1}><span>Cyber Security</span></MenuItem>
                            <MenuItem value={2}><span>Home Security</span></MenuItem>
                            <MenuItem value={3}><span>Food Security</span></MenuItem>
                        </Select>
                    </FormControl>
                </div>
                <div className='col-md-4'>
        ...
        <Button variant="contained" color="primary"
            onClick={() => setOpen(true)}>  Allocate training institude </Button>
        ...
        <Dialog
            ...
            <DialogTitle id="alert-dialog-slide-title">{"Allocate training institute"}</DialogTitle>
            <DialogContent>
                <div className="col-md-12">
                    <FormControl className={classes.formControl}>
                        <InputLabel id="demo-simple-select-helper-label">Training Academy</InputLabel>
            ...
            <DialogActions>
                ...
                <Button variant="contained" color="primary"
                    onClick={handleClose}>    Yes, Confirm</Button>
