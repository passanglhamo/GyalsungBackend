...
public class UserFullTest {
    ...
    @Mock private UserRepository repository1;
    ...
    public void fullTest(){
        ...
        when(repository1.save(any(User.class))).thenReturn(user1);
        when(repository1.findByUsername(any(String.class))).thenReturn(Optional.of(user1));
        ...
        stack.push(new SaveUser(repository, user));
        stack.push(new SaveRole(roleRepository, role));
        stack.push(new AssignRoleToUser(repository1, user, role));
        ...
        stack.push(new AssignPolicyToRole(roleRepository1, role, policy));
