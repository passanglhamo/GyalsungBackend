package com.microservice.erp.domain.beans;
...
public class TaskExecutionLogger {
    ...
    private static Logger LOG = LoggerFactory.getLogger(TaskExecutionLogger.class);

    @Around("execution(* com.microservice.erp.domain.beans.tasks..*(..))")
